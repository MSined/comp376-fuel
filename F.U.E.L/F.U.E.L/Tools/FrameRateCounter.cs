    ...
    public class FrameRateCounter : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (Game1.fpsCounterOn)
            {
                ...
                {
                    spriteBatch.DrawString(spriteFont, "SURVIVE!", new Vector2(Game.Window.ClientBounds.Width / 2, 78), Color.White);
                    spriteBatch.DrawString(spriteFont, "SURVIVE!", new Vector2(Game.Window.ClientBounds.Width / 2 - 2, 76), Color.Red);
                }
            }
